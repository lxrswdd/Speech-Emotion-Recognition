...
def directory_feature_extraction_no_avg_3D(folder_path, mid_window, mid_step,
    ...
    for i, file_path in enumerate(wav_file_list):
        ...
        if current_window_size<window_size:
            ...
            print('The audio is too long so truncation is processed.')
            mid_feature_vector = mid_feature_vector[0:6,:]
            continue
...
def multiple_directory_feature_extraction_no_avg_3D(path_list, mid_window, mid_step,
